...
public class ProjectMemberServiceImpl implements ProjectMemberService {
    ...
    public ProjectMemberServiceImpl(ProjectMemberRepository projectMemberRepository, DtoMapper mapper) {
    ...
    public ProjectMemberListDto get() {
        return new ProjectMemberListDto(projectMemberRepository.findAll()
                .stream()
    ...
    public ProjectMemberOutputDto add(ProjectMemberInputDto projectMemberInputDto) {
        ...
        return mapper.projectMemberToProjectMemberOutputDto(
                projectMemberRepository.save(mapper.projectMemberDtoToProjectMember(projectMemberInputDto))
        );
    }
    ...
    public ProjectMemberListDto getForProject(Long projectId) {
        return new ProjectMemberListDto(projectMemberRepository.findAllByProject_Id(projectId)
                .stream()
                .map(mapper::projectMemberToProjectMemberOutputDto)
                .collect(Collectors.toList()));
    }
