...
public class WorkController
        extends GenericCrudControllerImpl<WorkInputDto, WorkDto, WorkListDto, Long, WorkService> {
    ...
    @GetMapping("/for-day")
    public ResponseEntity<WorkListDto> getForDay(
    ...
    @GetMapping("/search")
    public ResponseEntity<WorkListDto> search(
            @PathParam("category") String category,
            @PathParam("project") String project,
            @PathParam("client") String client,
            @PathParam("employee") String lead,
        ...
        return new ResponseEntity<>(
                service.search(category, project, client, lead, startDate, endDate), HttpStatus.OK);
    }
}
